...
<html>
    ...
    <br>
    <form name="formulario" method="post" action="Vin_professor.jsp">
    ...
    <div id="conteudo">        
        <br>
        <form name="form2" action="./Cad_vin_professor.jsp" method="post">
            <table width="100%">
                ...
                <%
                    ...
                    if ((sCampoCodigo != "") && (sCampoNome != "")) {
                        sCondicao = "WHERE professores.pro_idunico = " + sCampoCodigo + " and professores.pro_nome like '%" + sCampoNome + "%';";
                        ...
                        sCondicao = "WHERE professores.pro_idunico > 0;";
                    }

                    SQL = "SELECT  professores.pro_idunico,professores.pro_sobrenome,professores.pro_nome from professores " + sCondicao;
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            iCodigo[iPosicao] = rs.getInt("PRO_IDUNICO");

                            sNome = rs.getString("PRO_NOME") + " " + rs.getString("PRO_SOBRENOME");

                            out.print("<tr bgColor='#C1CDCD'>");
                            out.print("<td width = '10%'><input type='text' name='codigo2' readonly='readonly' value='" + iCodigo[iPosicao] + "' ></td>");
