...
<html>
    ...
    <form name="cad_coordenador" method="post" action="Cad_aluno.jsp">
        <table width="90%" cellspacing="10px">        
            ...
            <tr>
                <td colspan="2">
                    TELEFONE:
                    <input type="text" name ="ddd" maxlength="2" size="2%"/><input type="text" name ="tel" maxlength="8">
                </td>
                <td colspan="3">
                    TELEFONE2:
                    <input type="text" name ="ddd2" maxlength="2" size="2%"> <input type="text" name ="tel2" maxlength="8">
                </td>
            </tr>
            <td colspan="2">
                ESTADO:
            ...
            <td colspan="3">
                CIDADE:
                <input type="text" name="cidade" size="30px" maxlength="20"/>
            </td>                       
            <tr>
        ...
        <%
            ...
            String sSexoAluno = request.getParameter("sexo");
            String sEstadoAluno = request.getParameter("estado");
            ...
            String sLoginAluno = request.getParameter("login");
            String sSenhaAluno = request.getParameter("senha");

            String sTipo = ("ALU");

            String sPerguntaAluno = request.getParameter("pergunta");
            ...
            try {
                ...
                SQL = "INSERT INTO ALUNOS "
                        + "(ALU_NOME,ALU_SOBRENOME,ALU_TELEFONE,ALU_TELEFONE2,ALU_SEXO,"
                        + "ALU_ESTADO,ALU_CIDADE,ALU_CEP,ALU_BAIRRO,ALU_ENDERECO,ALU_LOGIN,ALU_SENHA,PER_IDPERGUNTA)"
                        + "VALUES"
                        + "('" + sNome + "','" + sSobreNome + "','" + sDDD + sTelefone + "','" + sDDD2 + sTelefone2 + "','" + sSexoAluno + "',"
                        + "'" + sEstadoAluno + "','" + sCidade + "','" + sCep + "','" + sBairro + "','" + sEndereco + "',"
                        + "'" + sLoginAluno + "','" + sSenhaAluno + "','" + sPerguntaAluno + "');";

                statemant.execute(SQL);

                SQL = "INSERT INTO ACESSOS (ACE_LOGINUSU,ACE_NOMEUSU,ACE_SENHAUSU,ACE_TIPOUSU,ACE_IDUSUARIO,ACE_IDCURSOUSU)"
                        + " VALUES"
                        + "('" + sLoginAluno + "','" + sNome + "','" + sSenhaAluno + "','" + sTipo + "',"
                        + "(SELECT ALU_IDUNICO FROM ALUNOS order by ALU_IDUNICO DESC LIMIT 1),0)";
